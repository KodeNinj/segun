        ...
        <div  className='w-[100vw]  h-[calc(100vh)] fixed top-[0px] left-[0%] z-[100] bg-[var(--bg2)] text-black flex  overflow-y-scroll overflow-x-hidden pt-[32px] pb-[100px] justify-center items-center'>
            ...
            <div id='modal' className="container flex justify-around items-start md:flex-row-reverse flex-col w-[100%] overflow-auto h-full pt-[50px] ">
                ...
                <div className="right md:w-[45%] w-full px-[24px] md:h-full h-[50vh]">
                    ...
                    {/* the title */}
                    <h3 className='text-2xl md:text-3xl mb-[10px] text-[var(--secondary)] text-center md:text-left capitalize'>{popupDetails[0].title} (Dev project)</h3>
                    ...
                    <div className="details text-white w-full leading-[38px] font-light ">
                        ...
                        {/* the process */}
                        <p className='text-lg text-center text-[var(--secondary)] font-bold my-[10px]'>The Integration/Build</p>
                    ...
                    <div className="btns mt-[32px] flex items-center  justify-center gap-[20px] flex-wrap md:flex-row flex-col md:w-auto w-[80%] md:pl-0 pl-[20%]">
                        <a href={popupDetails[0].link1} target='_blank' rel="noreferrer"><button className='px-[24px] py-[12px] bg-[var(--secondary)] rounded-full text-xl'>View Live Link</button></a>
                        <a href={popupDetails[0].link2} rel="noreferrer" target='_blank'><button className='px-[24px] py-[12px] border-[2px] border-[var(--secondary)] rounded-full text-xl text-white'>Check Code</button></a>
