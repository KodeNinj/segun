...
const Navigation = () => {
  ...
  return (
    <nav className='flex items-center justify-between border-b-slate-100 shadow-md  lg:px-[100px] md:px-[40px] sm:px-[30px] px-[25px] h-[90px] bg-[var(--bg)] sticky w-full top-0 z-[100]'>
        ...
        <div id="mobile-links" className={isOn ? 'absolute top-[-100vh] ease duration-300 w-full left-0 h-screen' : 'md:hidden block absolute top-0 w-full h-screen  left-0 bg-[var(--bg)] ease duration-300 z-[1]'}>
